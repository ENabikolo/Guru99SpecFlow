...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Take x numbers", new string[] {
                "mytag"}, SourceLine=6)]
        public virtual void TakeXNumbers()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Take x numbers", new string[] {
                        "mytag"});
#line 7
...
#line 9
 testRunner.And("I entered 7 into the calculator", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 10
